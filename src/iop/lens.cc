...
#ifdef LF_2000
static int get_lensfun_updated_scale(dt_iop_module_t *self, dt_iop_lensfun_params_t *p,
                                const lfCamera *camera,
...
static void lens_set(dt_iop_module_t *self, const lfLens *lens)
{
  ...
  mounts[0] = 0;
#if defined(LF_0395) || defined(LF_2000)
...
void gui_update(struct dt_iop_module_t *self)
{
  ...
  if(p->modified == 0)
  {
    ...
    memcpy(self->params, self->default_params, sizeof(dt_iop_lensfun_params_t));
	  ...
	  update_lensfun_scale(self, p, NULL, g);
  }
#endif
